...
ifeq ($(MSH_DIR),)
all: 
	@echo Please specify MSH_DIR variable pointing to folder where msh library is stored. You can get msh from "https://github.com/mhalber/msh"
	@echo Example: make MSH_DIR=/usr/local/include/
else
all:
